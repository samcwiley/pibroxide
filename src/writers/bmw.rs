...
fn get_bmw_embellishment(embellishment: Embellishment) -> String {
    match embellishment {
        ...
        Embellishment::Slur(pitch) => format!("gst{}", BMWLowercase::new(pitch)),
        ...
        Embellishment::LGTaorluath => unimplemented!(),
        ...
        Embellishment::LGCrunluath => unimplemented!(),
        Embellishment::HeavyCrunluath => unimplemented!(),
        Embellishment::HeavyBCrunluath => unimplemented!(),
        Embellishment::Edre | Embellishment::Endari => String::from("edre"),
        Embellishment::Dare => String::from("dare"),
        Embellishment::Chedari => unimplemented!(),
        Embellishment::Embari => unimplemented!(),
        ...
        Embellishment::ThumbSlur(pitch) => format!("tst{}", BMWLowercase::new(pitch)),
        Embellishment::HalfSlur(pitch) => format!("hst{}", BMWLowercase::new(pitch)),
        Embellishment::LightDThumbSlur => String::from("lgstd"),
        Embellishment::LightDHalfSlur => todo!(),
        Embellishment::ThumbHornpipeShake(pitch) => format!("tpel{}", BMWLowercase::new(pitch)),
        Embellishment::HalfHornpipeShake(pitch) => format!("hpel{}", BMWLowercase::new(pitch)),
        Embellishment::LightDHornpipeShake => String::from("lpeld"),
        Embellishment::LightDThumbHornpipeShake => String::from("ltpeld"),
        Embellishment::LightDHalfHornpipeShake => String::from("lhpeld"),
        Embellishment::Catch(pitch) => format!("ggrp{}", BMWLowercase::new(pitch)),
        Embellishment::ThumbCatch(pitch) => format!("tgrp{}", BMWLowercase::new(pitch)),
        Embellishment::HalfCatch(pitch) => format!("hgrp{}", BMWLowercase::new(pitch)),
        Embellishment::DCatchBGraceNote => String::from("ggrpdb"),
        Embellishment::DThumbCatchBGraceNote => String::from("tgrpdb"),
        Embellishment::DHalfCatchBGraceNote => String::from("hgrpdb"),
        Embellishment::LowGDarodo => String::from("hbubly"),
    }
}
