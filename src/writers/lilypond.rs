...
fn get_lily_embellishment(embellishment: Embellishment) -> String {
    ...
    match embellishment {
        ...
        // tie holds a pitch b/c in BMW it needs to be told where to be placed,
        // lily does it automagically
        Embellishment::Tie(_) => String::from("~"),
        Embellishment::LightDSlur => String::from("\\wslurd"),
        Embellishment::ThumbSlur(pitch) => format!("\\tslur{}", get_lily_pitch(pitch)),
        Embellishment::HalfSlur(pitch) => format!("\\hslur{}", get_lily_pitch(pitch)),
        Embellishment::LightDThumbSlur => String::from("\\wtslurd"),
        Embellishment::LightDHalfSlur => String::from("\\whslurd"),
        Embellishment::ThumbHornpipeShake(pitch) => format!("\\tshake{}", get_lily_pitch(pitch)),
        Embellishment::HalfHornpipeShake(pitch) => format!("\\hshake{}", get_lily_pitch(pitch)),
        Embellishment::LightDHornpipeShake => String::from("\\wshaked"),
        Embellishment::LightDThumbHornpipeShake => String::from("\\wtshaked"),
        Embellishment::LightDHalfHornpipeShake => String::from("\\whshaked"),
        Embellishment::Catch(pitch) => format!("\\catch{}", get_lily_pitch(pitch)),
        Embellishment::ThumbCatch(pitch) => format!("\\tcatch{}", get_lily_pitch(pitch)),
        Embellishment::HalfCatch(pitch) => format!("\\hcatch{}", get_lily_pitch(pitch)),
        Embellishment::DCatchBGraceNote => String::from("\\wcatchd"),
        Embellishment::DThumbCatchBGraceNote => String::from("\\wtcatchd"),
        Embellishment::DHalfCatchBGraceNote => String::from("\\whcatchd"),
        Embellishment::LowGDarodo => String::from("\\Gdarodo"),
    }
}
